      ...
      <div className="max-w-sm w-full">
        ...
        <div className="mb-5">
          <label className="text-xs text-[#888888] uppercase tracking-wide block mb-2">
            Age <span className="text-[#555555] normal-case">(for an estimate)</span>
          </label>
          <input
            type="number"
            value={age}
            ...
            placeholder="28"
            className="w-full bg-[#161616] border border-[#1f1f1f] rounded-md px-3 py-2 text-sm text-[#ededed] placeholder-[#555555] outline-none focus:border-[#378ADD]"
          />
        </div>

        <div className="mb-5">
          <div className="flex items-center justify-between mb-2">
            <label className="text-xs text-[#888888] uppercase tracking-wide">
              Max heart rate
            </label>
            {maxHrTouched && age && (
              <button
